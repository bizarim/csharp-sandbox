...
namespace AppLobbyServer.ClientRequest
{
    ...
    public partial class ClientRequest
    {
        ...
        /// 에러코드
        /// </summary>
        protected LibCommon.Enums.ErrorType rtcode = LibCommon.Enums.ErrorType.Success;
        ...
        /// <param name="rt"></param>
        protected void SendCommonError(WebSocketSession session, int reqpn, LibCommon.Enums.ErrorType rt)
        {
            rtcode = rt;
